  ...
  <body id="page-top">
	...
	<div class="col-sm-5">
      <div class="card card-register mx-auto ml-20, mr-30">
		...
		<div>
		<center><?php  echo "<img src='image/".$row['Profile']."' width='20%' height='20%' class='avatar'>"; ?><br>
		  ...
		  <!--<div class="col-md-6">-->
            ...
            <div class="form-group">
              ...
              <!--<div class="form-row">-->
               <!--<div class="col-md-6">-->
			   <div class="p">
			    <label for="firstName"><pre style="font-family:Arial">Name		<b>:</b>			<?php echo $row['fullname']?></pre></label>
                 <!-- <div class="form-label-group">-->
				 
                   <!-- <input type="text" id="Name" class="form-control" autofocus="autofocus"  pattern="[A-Za-z]{1,10}"required>-->
...
<!--</div>-->
                ...
                <!--<div class="col-md-6">-->
				  <div class="p">
				  <label for="lastName"><pre style="font-family:Arial">Account No	<b>:</b>			<?php echo $row['account_no']?></pre></label>
                  <!--<div class="form-label-group">--->
                    <!--<input type="text" id="number" class="form-control"  pattern="[0-9]{10}" maxLength=10 required>-->
			  ...
			  <div class="form-group">
			<div class="p">
			<label for="inputAddress"><pre style="font-family:Arial">Address	        <b>:</b>	                <?php echo $row['address']?></pre> </label>
              <!--<div class="form-label-group">-->
                <!--<input type="email" id="Email" class="form-control" pattern="[^ @]*@[^ @]*" placeholder="" required>-->
			...
			<div class="form-group">
			<div class="p">
			<label for="inputEmail"><pre style="font-family:Arial">Email address	<b>:</b>			<?php echo $row['email']?></pre> </label>
              <!--<div class="form-label-group">-->
                <!--<input type="email" id="Email" class="form-control" pattern="[^ @]*@[^ @]*" placeholder="" required>-->
			...
			<div class="form-group"> 
			<div class="p">
			<label for="inputMobile"><pre style="font-family:Arial">Mobile No	<b>:</b>			<?php echo $row['phone']?> </pre></label>
              <!--<div class="form-label-group">-->
                <!--<input type="text" id="number" class="form-control"  pattern="[0-9]{10}" maxLength=10 >-->
           ...
           <!-- </div>-->
			...
			<br>
			<div class="p">
			<a href='profile.php?account_no=<?php echo $row['account_no']?>' title='Edit Record' data-toggle='tooltip' class="btn btn-primary btn-block" style="background-color:#2196f3">Edit profile</a><br>

            <!--<button type="submit" class="btn btn-primary btn-block" formaction="profile.php?account_no=<?php //echo $row['account_no']?>" style="background-color:#dc3545">Edit profile</button></div>-->
          </form>
